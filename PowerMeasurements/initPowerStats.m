...
powerstats.voltage                    = []; % will be optionally filled with velocity, w, or pressure for mechanical power?? 
powerstats.current                    = []; % optionally filled with force, torque, or Q? 
powerstats.power                      = [];
